...
ActiveRecord::Schema.define(version: 20160729125349) do
  ...
  create_table "movies_actors", force: :cascade do |t|
    t.integer "movie_id"
    t.integer "actor_id"
    t.index ["actor_id"], name: "index_movies_actors_on_actor_id", using: :btree
    t.index ["movie_id"], name: "index_movies_actors_on_movie_id", using: :btree
  end
